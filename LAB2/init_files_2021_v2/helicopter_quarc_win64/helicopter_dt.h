...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter_B.TravelCounttorad), 0, 0, 14 }
  ,
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&helicopter_P.HILInitialize_OOTerminate), 0, 0, 47 },
